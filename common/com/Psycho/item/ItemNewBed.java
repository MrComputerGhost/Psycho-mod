...
public class ItemNewBed extends Item
{
    public ItemNewBed(int par1)
    {
        super(par1);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            ++par5;
            BlockNewBed blocknewbed = (BlockNewBed)IBAManager.BlockNewBed;
            ...
            if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) && par2EntityPlayer.canPlayerEdit(par4 + b0, par5, par6 + b1, par7, par1ItemStack))
            {
                ...
                {
                    par3World.setBlock(par4, par5, par6, blocknewbed.blockID, i1, 3);

                    if (par3World.getBlockId(par4, par5, par6) == blocknewbed.blockID)
                    {
                        par3World.setBlock(par4 + b0, par5, par6 + b1, blocknewbed.blockID, i1 + 8, 3);
                    }
